...
import Paints from "./routes/Internal/Recipaint/Paints";
...
import XenBudgetBookGoals from "./routes/Internal/XenBudget/BookGoals";
  ...
  createRoutesFromElements(
    <>
      ...
      >
        ...
        <Route path="recipaint/paints" element={<Paints />} />
        ...
        <Route path="xenbudget">
          ...
          <Route path="books/:bookId" element={<XenBudgetBookDetail />}>
            ...
            <Route path="goals" element={<XenBudgetBookGoals />} />
