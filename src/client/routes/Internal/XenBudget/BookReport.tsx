...
export default function BookReport() {
    ...
    const { status: budgetStatusResponse, budgets } = useXenBudgetStatus(
        book._id, currency, budgetRange, 12, period,
    );
    ...
    const exportCsv = () => {
        ...
        const rows: unknown[][] = [
            ...
            [],
            summaryCsvRow("Targets — Counted", categoryReport.summary.towardTargets),
            summaryCsvRow("Targets — Target", categoryReport.summary.targets),
            summaryCsvRow("Targets — Short by", minusTotals(categoryReport.summary.targets, categoryReport.summary.towardTargets)),
