...
export default function BookReport() {
    ...
    const exportCsv = () => {
        ...
        const rows: unknown[][] = [
            ...
            [],
            summaryCsvRow("Income — Received", categoryReport.summary.towardTargets),
            summaryCsvRow("Income — Target", categoryReport.summary.targets),
            summaryCsvRow("Income — Short by", minusTotals(categoryReport.summary.targets, categoryReport.summary.towardTargets)),
