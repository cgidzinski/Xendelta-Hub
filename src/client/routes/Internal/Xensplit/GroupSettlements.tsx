...
export default function GroupSettlements() {
    const { balancesData, group, user, settleDebt, isSettlingDebt, deleteSettlement, isDeletingSettlement, onAddExchange, showDeleted } = useOutletContext<GroupDetailContext>();
